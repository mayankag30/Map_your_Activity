...
class App {
  ...
  constructor() {
    ...
    // Handling the change event on select type of workout
  ...
  _loadMap(position) {
    ...
    // Adding the workouts on the map after it is loaded
  ...
  _newWorkout(e) {
    ...
    // Render new Workout on sidebar list
    this._renderWorkout(workout);

    // Hide the form + Clear Input Fields after submitting
    this._hideForm();
